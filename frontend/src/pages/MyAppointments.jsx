...
const MyAppointments = () => {
  ...
  const cancelAppointment = async (appointmentId, docId, slotDate, slotTime) => {
    try {

      const { data } = await axios.post(backendUrl + '/api/user/cancel-appointment', { appointmentId, docId, slotDate, slotTime }, { headers: { token } })
      if (data.success) {
  ...
  const appointmentRazorpay = async (appointmentId) => {
    ...
    try {
      ...
      console.log("Raw payment API response:", data)
