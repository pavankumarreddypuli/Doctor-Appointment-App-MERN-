...
export const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      //Axios is a popular JavaScript library for making HTTP requests (GET, POST, PUT, DELETE) from browser or Node.js.
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <p className='bg-white px-8 py-8 border'>Add Doctor</p>
...
//URL.createObjectURL(file) creates a temporary local URL (a blob URL) for that file so the browser can display it.